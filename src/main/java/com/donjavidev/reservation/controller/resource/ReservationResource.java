...
public interface ReservationResource {
    ...
    @Operation(description = "Get the information of all the reservations", responses = {
            ...
            @ApiResponse(responseCode = "500", description = "Internal Server Error - Something bad happened", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorDto.class)))
    ...
    @Operation(description = "Create one reservation", responses = {
            @ApiResponse(responseCode = "200", description = "Return the created reservation", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ReservationDto.class))) }, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(examples = @ExampleObject(name = "Reservation", summary = "Example Reservation to create", value = "{\n"
                    + "    \"passengers\": [\n" + "        {\n" + "            \"firstName\": \"Andres\",\n"
    ...
    @Operation(description = "Update one reservation", responses = {
            @ApiResponse(responseCode = "200", description = "Return the updated reservation", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ReservationDto.class))) }, parameters = {
    ...
    @Operation(description = "Delete one reservation", responses = {
            ...
            @ApiResponse(responseCode = "200", description = "Internal Server Error - Something bad happened getting the reservation", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorDto.class))) }, parameters = {
